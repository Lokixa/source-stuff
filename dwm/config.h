...
static const char *const autostart[] = {"/home/lyubenk/.screenlayout/default.sh",
                                        NULL,
                                        "/home/lyubenk/.fehbg",
                                        NULL,
                                        "easyeffects",
...
static Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3) TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5)
        TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7) TAGKEYS(XK_9, 8){MODKEY | ShiftMask, XK_c, quit, {0}},
    {0, XK_Print, spawn, SHCMD("maim -s -u | xclip -selection clipboard -t image/png -i")},
    {ShiftMask, XK_Print, spawn, SHCMD("maim -s -u >> ~/Pictures/Screenshot-$(date +%Y_%m_%d-%H_%M_%S).png")},
    ...
    {0, XF86XK_HomePage, spawn, SHCMD("pamixer --default-source -t")},
};
